...
module.exports = ({
  ...
  return new Promise((resolve, reject) => {
            ...
            var _ref3 = (0, _asyncToGenerator2.default)(function* (resolve) {
              ...
              const ast = yield new Promise((resolve, reject) => {
                ...
                Promise.each(pluginOptions.plugins, plugin => {
                  ...
                  const files = getNodes().filter(n => n.internal.type === `File`); // Use Bluebird's Promise function "each" to run remark plugins serially.
    ...
    function _getTableOfContents() {
      _getTableOfContents = (0, _asyncToGenerator2.default)(function* (markdownNode) {
