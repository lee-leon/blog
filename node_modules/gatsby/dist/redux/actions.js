...
var joiSchemas = _interopRequireWildcard(require("../joi-schemas/joi"));
...
actions.createNode = (node, plugin, actionOptions = {}) => {
  ...
  if (node.internal.owner) {
    ...
    console.log(_chalk.default.bold.red(`The node internal.owner field is set automatically by Gatsby and not by plugins`));
    process.exit(1);
  ...
  const result = _joi.default.validate(node, joiSchemas.nodeSchema);

  if (result.error) {
    console.log(_chalk.default.bold.red(`The new node didn't pass validation`));
    console.log(_chalk.default.bold.red(result.error));
    console.log(node);
    return {
