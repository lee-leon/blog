...
function () {
  var _ref = (0, _asyncToGenerator2.default)(function* (args) {
    ...
    initCache(); // Ensure the public/static directory and data subdirectories are created.

    yield fs.ensureDir(`${program.directory}/public/static`);
    yield Promise.all(_.range(0, 999).map(i => fs.ensureDir(`${program.directory}/public/static/d/${i}`)));
