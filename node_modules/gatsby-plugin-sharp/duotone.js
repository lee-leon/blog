...
/*#__PURE__*/
function () {
  var _duotone = (0, _asyncToGenerator2.default)(function* (duotone, format, clonedPipeline) {
    const duotoneGradient = createDuotoneGradient(hexToRgb(duotone.highlight), hexToRgb(duotone.shadow)); // @todo remove once we upgrade to sharp v0.18 which
    ...
    const duotoneImage = yield clonedPipeline.raw().toBuffer({
...
function overlayDuotone(_x4, _x5, _x6, _x7) {
  return _overlayDuotone.apply(this, arguments);
}

function _overlayDuotone() {
  _overlayDuotone = (0, _asyncToGenerator2.default)(function* (duotoneImage, originalImage, duotone, format) {
