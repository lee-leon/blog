...
var _require = require("../internals"),
    regexExclude404AndOfflineShell = _require.regexExclude404AndOfflineShell;

describe("gatsby-plugin-sitemap", function () {
  it("regex for filtering out 404 pages", function () {
    var regex = new RegExp(regexExclude404AndOfflineShell); // 404 pages
    ...
    expect(regex.exec("/404-and-now-anything")).toBeNull(); // gatsby-plugin-offline app shell fallback

    expect(regex.exec("/offline-plugin-app-shell-fallback")).toBeNull(); // Generic valid pages
