      ...
      while (1) {
        switch (_context.prev = _context.next) {
          case 0:
            ...
            _defaultOptions$optio = (0, _extends2.default)({}, _internals.defaultOptions, options), query = _defaultOptions$optio.query, serialize = _defaultOptions$optio.serialize, output = _defaultOptions$optio.output, exclude = _defaultOptions$optio.exclude, rest = (0, _objectWithoutProperties2.default)(_defaultOptions$optio, ["query", "serialize", "output", "exclude"]);
